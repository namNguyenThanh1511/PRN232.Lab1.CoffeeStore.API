...
namespace PRN232.Lab2.CoffeeStore.Repositories
{
    public class CoffeStoreDbContext : DbContext
    {
        ...
        new Menu { Id = Guid.Parse("16161616-1616-1616-1616-161616161616"), Name = "Seasonal Menu", FromDate = new DateTime(2025, 1, 1), ToDate = new DateTime(2025, 12, 31), CreatedDate = new DateTime(2025, 1, 1) },
            ...
            var products = new[]
            {
        new Product { Id = Guid.Parse("17171717-1717-1717-1717-171717171717"), Name = "Espresso", Price = 2.5m, Description = "Strong black coffee", CategoryId = Guid.Parse("11111111-1111-1111-1111-111111111111"), CreatedDate = new DateTime(2025, 1, 1), IsActive = true },
        new Product { Id = Guid.Parse("18181818-1818-1818-1818-181818181818"), Name = "Latte", Price = 3.0m, Description = "Coffee with steamed milk", CategoryId = Guid.Parse("11111111-1111-1111-1111-111111111111"), CreatedDate = new DateTime(2025, 1, 1), IsActive = true },
        new Product { Id = Guid.Parse("19191919-1919-1919-1919-191919191919"), Name = "Green Tea", Price = 1.8m, Description = "Refreshing green tea", CategoryId = Guid.Parse("22222222-2222-2222-2222-222222222222"), CreatedDate = new DateTime(2025, 1, 1), IsActive = true },
        new Product { Id = Guid.Parse("20202020-2020-2020-2020-202020202020"), Name = "Orange Juice", Price = 2.2m, Description = "Fresh squeezed orange juice", CategoryId = Guid.Parse("33333333-3333-3333-3333-333333333333"), CreatedDate = new DateTime(2025, 1, 1), IsActive = true },
        new Product { Id = Guid.Parse("21212121-2121-2121-2121-212121212121"), Name = "Berry Smoothie", Price = 3.5m, Description = "Mixed berry smoothie", CategoryId = Guid.Parse("44444444-4444-4444-4444-444444444444"), CreatedDate = new DateTime(2025, 1, 1), IsActive = true },
        new Product { Id = Guid.Parse("22222222-3333-4444-5555-666666666666"), Name = "Croissant", Price = 1.5m, Description = "Buttery French pastry", CategoryId = Guid.Parse("55555555-5555-5555-5555-555555555555"), CreatedDate = new DateTime(2025, 1, 1), IsActive = true },
        new Product { Id = Guid.Parse("23232323-2323-2323-2323-232323232323"), Name = "Club Sandwich", Price = 4.5m, Description = "Triple-decker sandwich", CategoryId = Guid.Parse("66666666-6666-6666-6666-666666666666"), CreatedDate = new DateTime(2025, 1, 1), IsActive = true },
        new Product { Id = Guid.Parse("24242424-2424-2424-2424-242424242424"), Name = "Spaghetti Bolognese", Price = 6.5m, Description = "Classic Italian pasta", CategoryId = Guid.Parse("77777777-7777-7777-7777-777777777777"), CreatedDate = new DateTime(2025, 1, 1), IsActive = true },
        new Product { Id = Guid.Parse("25252525-2525-2525-2525-252525252525"), Name = "Margherita Pizza", Price = 7.0m, Description = "Cheese and tomato pizza", CategoryId = Guid.Parse("88888888-8888-8888-8888-888888888888"), CreatedDate = new DateTime(2025, 1, 1), IsActive = true },
        new Product { Id = Guid.Parse("26262626-2626-2626-2626-262626262626"), Name = "Caesar Salad", Price = 5.0m, Description = "Salad with romaine lettuce and dressing", CategoryId = Guid.Parse("99999999-9999-9999-9999-999999999999"), CreatedDate = new DateTime(2025, 1, 1), IsActive = true },
    };
